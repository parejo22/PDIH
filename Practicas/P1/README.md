...
Este programa nos muestra los diferentes modos de video que podemos usar y nos da la posibilidad de cambiar entre ellos(El código ha sido corregido, ya que las tildes no las reconoce bien):
...
Para mostrar el funcionamiento me ayudaré de setvideomode(), para asi poder demostrar que realmente se está leyendo el modo de video y que no se está mostrando un mensaje:
