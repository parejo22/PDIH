...
![Corazón](https://github.com/user-attachments/assets/1233d4c0-597a-4629-bd73-0a862bcf5fb2)
...
Se han dibujado varios círculos concéntricos de diferentes colores empleando el operador `arc` junto con `fill`, variando el radio para conseguir el efecto de capas. Otra opción, sin usar `fill`, habría sido jugar con el tamaño del borde.

[Enlace al código](https://github.com/parejo22/PDIH/blob/main/Practicas/P4/sonrisa.ps)

![Sonrisa](https://github.com/user-attachments/assets/7539e36f-b5a1-47bc-b375-2b53f0fb8776)
...
En la segunda página se ha añadido una gráfica sencilla. Los ejes de la gráfica se han creado mediante líneas, y la representación de los datos se ha realizado dibujando círculos enlazados por líneas rectas.
...
![Tabla y gráfica](https://github.com/user-attachments/assets/d509c31d-a193-48d0-85fc-22a6b4cad3d0)
...
![Conversión](https://github.com/user-attachments/assets/277e550b-074c-407e-9b4f-5ea6f6cf8b4b)
